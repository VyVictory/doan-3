    ...
    return (
        <div className=''>
            ...
            <div className='grid justify-center relative z-0 bottom-20 overflow-hidden'>
                ...
                <h1 className='font-bold text-2xl text-center mt-5'>{dataProfile && dataProfile.lastName ? dataProfile.lastName:'err name'} {dataProfile && dataProfile.firstName ? dataProfile.firstName:'err name'}</h1>
            </div>
        </div>
