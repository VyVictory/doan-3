    ...
    return (
        <div className='bg-[#0f172a] mt-2'>
            <TabGroup>
                ...
                <TabPanels>
                    <TabPanel className={"grid grid-cols-4"}> <Allfriend /> <Allfriend /> <Allfriend /> <Allfriend /> <Allfriend /> <Allfriend /> </TabPanel>
                    <TabPanel className={"grid grid-cols-4"}><Friendinvitation /><Friendinvitation /><Friendinvitation /><Friendinvitation /> <Friendinvitation /> <Friendinvitation /></TabPanel>
                </TabPanels>
            </TabGroup>
        </div>
    )
