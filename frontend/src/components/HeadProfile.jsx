...
export default function HeadProfile() {
    return (
        <div className=' text-white grid gap-96'>
            <div className="w-full h-[400px] z-0 absolute grid bg-center" style={{ "background": `10% / cover no-repeat url('https://www.travelandleisure.com/thmb/xhs5KqfgyqZwdEAqaWu_d7R2gR4=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/blue0517-4dfc85cb0200460ab717b101ac07888f.jpg')` }}></div>
